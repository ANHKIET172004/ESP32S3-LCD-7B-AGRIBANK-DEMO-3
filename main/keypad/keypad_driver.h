...
#define COL1 GPIO_NUM_13
#define COL2 GPIO_NUM_12
#define COL3 GPIO_NUM_14
#define COL4 GPIO_NUM_27

#define ROW4 GPIO_NUM_26
#define ROW3 GPIO_NUM_25
#define ROW2 GPIO_NUM_33
#define ROW1 GPIO_NUM_32
